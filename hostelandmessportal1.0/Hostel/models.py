...
class InOutList(models.Model):
	...
	def __str__(self):
		return str(self.student)+','+str(self.in_time)+','+str(self.out_name)+','+str(self.out_reason)+','+str(self.out_place)
...
class GuestEntry(models.Model):
	...
	relation=models.CharField(max_length=100,default=None)
	def __str__(self):
		return str(self.student)+','+str(self.guest_gender)+','+str(self.guest_name)+','+str(self.no_of_stay)+','+str(self.guest_age)+','+str(self.relation)
